...
When solving the nonogram puzzles, line up your clue pages with the baseplate that you will be using as a nonogram grid, using the grey lines that are drawn along the long edges of the clue sheets, as shown in the image above.<br><br>
