...
- You will need to have all of the differently colored 1 x 1 plate scans that will make up your mosaic within the "1 x 1 plate scans" folder in JPEG format, with the file names starting with the parenthesized RGB values, followed by the color name. This will allow the Python code to generate a thumbnail image of the mosaic and to include a solution key in the PDF documents. A procedure is included in the PDF document guiding you on how to add more colors to the "1 x 1 plate scans" folder. 
