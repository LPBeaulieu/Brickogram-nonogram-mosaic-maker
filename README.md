...
- You will need to have all the scans of the differently colored 1 x 1 plate that will make up your mosaic present within the "1 x 1 plate scans" folder in JPEG format, with the file names starting with the parenthesized RGB values, followed by the color name (ex: "(0, 85, 191) Blue.jpg"). This will allow the Python code to generate a thumbnail image of the mosaic and to add a solution key in the PDF documents. A procedure is included in the PDF document guiding you on how to add more colors to the "1 x 1 plate scans" folder. 
